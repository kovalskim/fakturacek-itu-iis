...
(function(global, factory) {
	...
	Nette.showFormErrors = function(form, errors) {
		...
		/** Some edits by Radek Jůzl, Martin Kovalski */
		/** Delete old errors */
		var error_divs = document.getElementsByClassName('invalid-feedback');

		for (let j = error_divs.length - 1; j >= 0; --j) {
			error_divs[j].remove();
		}
		/** ------ */
